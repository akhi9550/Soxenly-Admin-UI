...
export default function AdminLayout() {
  ...
  return (
    <div className="min-h-screen bg-neutral-100 font-display flex">
      {/* SIDEBAR */}
      <aside className="w-64 border-r-4 border-soxenly-beige bg-soxenly-cream flex flex-col hidden md:flex shrink-0">
        ...
        <nav className="flex-1 flex flex-col p-4 space-y-2">
          ...
          <Link to="/banners" className={navItemClass("/banners")}>Banners</Link>
        </nav>
